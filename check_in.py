...
class CheckIN:
    ...
    def __init__(self, root):
        ...
        # display message
        self.label = Label(self.top, font=('arial', 50, 'bold'), text="CHECK IN", fg="#84b1d1", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # name label
        self.name_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR NAME :", fg="#84b1d1",anchor="w")
        ...
        # address label
        self.address_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR ADDRESS :", fg="#84b1d1",anchor="w")
        ...
        self.mobile_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR MOBILE NUMBER :",fg="#84b1d1",anchor="w")
        ...
        self.days_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER NUMBER OF DAYSTO STAY :",fg="#84b1d1",anchor="w")
        ...
        # room number label
        self.room_number_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ROOM NUMB: ",fg="#84b1d1",anchor="w")
        ...
        def submit_info():
            ...
            if ans == TRUE and ans1 == True:
                ...
                cursor.execute('INSERT INTO Hotel (FullName,Address,mobile_number,number_days,room_number) ''VALUES(?,?,?,?,?)', (name, address, mobile, days, room))
                conn.commit()
                with conn:
        ...
        self.submit_button = Button(self.checkbox, text="SUBMIT", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2,width=15,fg="black", anchor="center", command=submit_info)
        self.submit_button.grid(row=5, column=1, padx=10, pady=10)

        # back to home page
        self.back_home_button = Button(self.checkbox, text="HOME", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2,width=15,fg="black", anchor="center", command =
                                       lambda: self.root.destroy() or main.home_ui)
        self.back_home_button.grid(row=5, column=2, padx=10, pady=10)

        Button(self.checkbox, text="reset", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2, width=15, fg="black",anchor="center", command=reset).grid(row=5, column=3)
