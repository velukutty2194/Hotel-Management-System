...
class CheckOut:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('arial', 50, 'bold'), text="CHECK OUT", fg="#84b1d1", anchor="center")
        ...
        self.check_out_button = Button(bottom, text="CHECK OUT", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2,width=15,fg="black", anchor="center", command=check_out)
        self.check_out_button.grid(row=3, column=2, padx=10, pady=10)

        # create submit button
        self.home_button = Button(bottom, text="HOME", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2, width=15,fg="black", anchor="center", command =lambda: self.root.destroy() or main.home_ui)
