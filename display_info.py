...
class GetInfo:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('arial', 50, 'bold'), text="INFORMATION OF THE CUSTOMERS", fg="#84b1d1",anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # room no label
        self.room_no_label = Label(bottom, font=('arial', 20, 'bold'), text="ENTER THE ROOM NUMBER :", fg="#84b1d1",anchor="center")
        ...
        self.submit_button = Button(button_frame, text="SUBMIT", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2,width=15, fg="black", anchor="center", command=get_info)
        self.submit_button.grid(row=8, column=2, padx=10, pady=10)

        # create home button
        self.home_button = Button(button_frame, text="HOME", font=('', 15), bg="#84b1d1", relief=RIDGE, height=2,width=15, fg="black", anchor="center", command=lambda: self.root.destroy() or main.home_ui)
